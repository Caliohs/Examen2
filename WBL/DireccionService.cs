...
namespace WBL
{
    ...
    public class DireccionService : IDireccionService
    {
        ...
        public async Task<IEnumerable<DireccionEntity>> Get()
        {
            try
            {
                var result = sql.QueryAsync<DireccionEntity,PersonaEntity,CatalogoProvinciaEntity,CatalogoCantonEntity,CatalogoDistritoEntity>
                    ("DireccionObtener","IdPersona,IdCatalogoProvincia,IdCatalogoCanton,IdCatalogoDistrito");
